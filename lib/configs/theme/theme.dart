...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color.fromARGB(255, 42, 194, 123),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.light,
      primary: Color.fromARGB(255, 40, 201, 139),
      surfaceTint: Color(0xff256a4a),
      onPrimary: Color(0xffffffff),
      ...
      primaryFixedDim: Color(0xff196041),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff083744),
      onTertiaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color.fromARGB(255, 70, 173, 115),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color.fromARGB(255, 96, 204, 141),
      surfaceTint: Color(0xff90d5ae),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff8cd1aa),
      onPrimaryContainer: Color(0xff000e06),
      secondary: Color(0xffddf6e4),
